...
import { Moon, Sun, Bell, Globe, Lock, Trash2, HelpCircle, Info } from 'lucide-react-native';
...
export default function SettingsScreen() {
  ...
  const renderSettingItem = (
    ...
    <View style={[styles.settingItem, { borderBottomColor: colorScheme.border }]}>
      <View style={styles.settingIcon}>{icon}</View>
      <View style={styles.settingContent}>
        <Text style={[styles.settingTitle, { color: colorScheme.text }]}>{title}</Text>
        <Text style={[styles.settingSubtitle, { color: colorScheme.secondaryText }]}>{subtitle}</Text>
      </View>
    ...
    <View style={[styles.container, { backgroundColor: colorScheme.background }]}>
      ...
      >
        <Animated.View entering={FadeIn.delay(300).duration(1000)}>
          ...
          {renderSettingItem(
            isDark ? <Moon size={24} color={colorScheme.primary} /> : <Sun size={24} color={colorScheme.primary} />,
            'Dark Mode',
          ...
          <Text style={[styles.sectionTitle, { color: colorScheme.text, marginTop: 24 }]}>
            Notifications
          </Text>
          ...
          {renderSettingItem(
            ...
            <TouchableOpacity
              style={[styles.buttonContainer, { backgroundColor: colorScheme.error }]}
          ...
          {renderSettingItem(
            ...
            <TouchableOpacity
              style={[styles.buttonContainer, { backgroundColor: colorScheme.primary }]}
        ...
        <View style={styles.versionContainer}>
          <Text style={[styles.versionText, { color: colorScheme.secondaryText }]}>
            Version 1.0.0
          </Text>
        </View>
      </ScrollView>
